...
<body>
    ...
    <section class="page-hero">
        <div class="hero-container">
            ...
            <h2 class="note-title">不產生新陣列的反轉</h2>
            <p class="hero-desc">練習資料結構的就地處置（In-place），透過中間變數完成元素對調。</p>
    ...
    <div class="note-container">
        <div class="note-card">
            <h3 class="note-subtitle">陣列元素反轉</h3>
            <div class="ques-section">
                <strong class="is-bracket-heading">【題目需求】</strong>
                <ul class="custom-list">
                    <li>在不產生新陣列的狀況下，將一個陣列的元素順序反轉</li>
                    <li>利用迴圈實作置換邏輯</li>
                    <li>範例：[2,4,6,1,8] 反轉後為 [8,1,6,4,2]</li>
                </ul>
            </div>
...
?>
            ...
            <aside class="note-reference-box" aria-label="延伸閱讀">
                ...
                <ul class="note-reference-list">
                    ...
                    <li>
                        <a href="https://github.com/mackliu/11501-FULL-BASIC/blob/main/15-pra11.php" target="_blank" rel="noopener noreferrer">11501 全端班：本題對照原始碼（15-pra11.php）</a>
                    </li>
                </ul>
            </aside>
        </div>
    ...
    <div class="note-container note-lesson-nav-wrap">
        <div id="note-lesson-nav-root" data-lesson-id="15-pra11"></div>
    </div>
