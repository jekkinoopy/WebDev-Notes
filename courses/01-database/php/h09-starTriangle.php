...
<head>
    ...
    <title>函式練習：星星正三角形 - 努比的全端筆記</title>
...
<body>
    ...
    <section class="page-hero">
        <div class="hero-container">
            <span class="category-tag">函式練習</span>
            <h2 class="note-title">給定行數，印出正三角形星星</h2>
            <p class="hero-desc">給定正整數 n，用函式印出 n 行星星。完成後可再自行延伸菱形、方形等圖形函式。</p>
    ...
    <div class="note-container">
        <div class="note-card">
            <h3 class="note-subtitle">正三角形：由小到大累加</h3>
            <div class="ques-section">
                <strong class="is-bracket-heading">【題目需求】</strong>
                <ul class="custom-list">
                    <li>輸入：一個正整數 n（n &gt; 0）。</li>
                    <li>輸出：印出 n 行星星（第 i 行印 i 顆，i 從 1 到 n）。</li>
                    <li>請用函式封裝，例如 <code>printTriangle($n)</code>。</li>
                    <li>（選做）依相同思路設計印菱形、方形的函式。</li>
                </ul>
            </div>
...
?>
    ...
    <div class="note-container note-lesson-nav-wrap">
        <div id="note-lesson-nav-root" data-lesson-id="h09-starTriangle"></div>
    </div>
