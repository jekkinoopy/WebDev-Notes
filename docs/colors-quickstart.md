...
> 本檔為原根目錄「色彩說明」內容，與 [`COLOR-GUIDE.md`](../COLOR-GUIDE.md) 搭配；專案總覽請看根目錄 [`README.md`](../README.md)。

### 📄 相關檔案

* **`assets/css/colors-config.css`** - 統一的色彩配置檔
    * 所有顏色變數集中定義
    * 包含 8 種預設配色方案
    * 詳細的說明註釋
...
1. 打開 `assets/css/colors-config.css`（若路徑不同請以專案內實際為準）
...
2. 🎨 預覽頁面：`colors-preview.html`
3. ⚙️ 配置檔：`assets/css/colors-config.css`
